...
var catAutos =  Comics.findOrCreate({
  ...
  profilePic:"https://wallpapers.com/images/high/venom-comic-book-yiq4h1381bwpvr8l.jpg",
  pages:50,
  banner:true,
  creators:["HENRYs"]
},
...
var catDeportes =  Comics.findOrCreate({
  where:{
    ...
    profilePic:"https://wallpapers.com/images/high/red-deadpool-comic-book-o0acbz3rtrkq1on6.jpg",
    pages:50,
    banner:true,
    creators:["HENRYs"]
  },
...
var catVideojuegos =  Comics.findOrCreate({
  where:{
    ...
    profilePic:"https://wallpapers.com/wallpapers/sitting-thanos-comic-book-tfb685lrvo6g6b0b.html",
    pages:50,  
    banner:true,
    creators:["HENRYs"]
  },
...
var catVideojuegos2 =  Comics.findOrCreate({
  ...
  profilePic:"https://wallpapers.com/wallpapers/the-joker-comic-book-ar6jo7r3w1y7bflt.html?embed=true",
  pages:50,
  banner:true,
  creators:["HENRYs"]
},
